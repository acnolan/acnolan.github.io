...
(function () {
  ...
  const get_data = function (vars) {
    ...
    let rcb; let pcb; let
      tcb; // Save callbacks to apply later.
  ...
  const on_load = function (f) {
    if (document.body === null) { document.addEventListener('DOMContentLoaded', () => { f(); }, false); } else { f(); }
  };
  ...
  window.goatcounter.bind_events = function () {
    ...
    Array.prototype.slice.call(document.querySelectorAll('*[data-goatcounter-click]')).forEach((elem) => {
  ...
  window.goatcounter.visit_count = function (opt) {
    on_load(() => {
      ...
      for (const k in opt.attr) { d.setAttribute(k, opt.attr[k]); }
